package com.minhtetoo.asartaline.utils;
...
public class AppConstants {
    ...
    public static final String API_GET_JOB_SEEKERS = "getPersonsAppliedJob.php";

    public static final String API_LOGIN_ONE_TIME_JOBS = "login.php";
    public static final String API_LOGIN_WITH_SOCIAL = "loginSocialMedia.php";
